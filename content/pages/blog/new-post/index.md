...
featuredImage:
  image: large.jpg
  alt: A man is walking in a lively office.
  caption: A man is walking in a lively office.
hashtags:
  - hashtag: gatsby
  - hashtag: remark
published: true
description: Hello, world! This is a demo post for gatsby-theme-novela. Novela
  is built by the team at Narative, and built for everyone that loves the web.
template: post
---
